...
ah1 = plot_distinct(earlyVlate_act_hom, "early_activating", "late_activating", "Distinct Early\nActivating", "Distinct Late\nActivating" )
bh1 = plot_distinct(earlyVlate_rep_hom, "early_repressive", "late_repressive", "Distinct Early\nRepressive", "Distinct Late\nRepressive" )
...
plot_grid(a1, ah1, labels = c("Bart", "Homer"), hjust = -2)
plot_grid(b1, bh1, labels = c("Bart", "Homer"), hjust = -2)
...
plot_distinct_gene(earlyvlate_hom, "early", "late", gene_expr_filt )
plot_distinct_gene(earlyvlate_all_hom, "early_all", "late_all", gene_expr_filt )
...
plot_pathways(earlyvlate_hom, "early", "late", gene_expr_filt )
plot_pathways(earlyvlate_all_hom, "early_all", "late_all", gene_expr_filt )
