...
plot_grid(c2, ch2, nrow = 2, rel_heights = c(.7, .3), labels = c("Bart", "Homer"))
plot_grid(d2, dh2, nrow = 2, rel_heights = c(.6, .4), labels = c("Bart", "Homer"))
```
```{r pathways, fig.height=7, fig.width=16}

c3 = plot_pathways(earlyvlate, "early", "late", gene_expr_filt )
d3 = plot_pathways(earlyvlate_all, "early_all", "late_all", gene_expr_filt )

ch3 = plot_pathways(earlyvlate_hom, "early", "late", gene_expr_filt )
dh3 = plot_pathways(earlyvlate_all_hom, "early_all", "late_all", gene_expr_filt )

plot_grid(c3, ch3, labels = c("Bart", "Homer"))
plot_grid(d3, dh3, labels = c("Bart", "Homer"))
```
...
plot_grid(plot_grid(ch1, c1, ncol = 1, labels = c("A\t\t\t\t\tMotif Enrichment", "B\t\t\t\t\tChIP Enrichment"), hjust = 0),
          plot_grid(ch2, c2, ncol = 1, rel_heights = c(.4, .6), labels = c("C", "D")),
          ncol = 2)

# all peaks
plot_grid(plot_grid(dh1, d1, ncol = 1, labels = c("A\t\t\t\t\tMotif Enrichment", "B\t\t\t\t\tChIP Enrichment"), hjust = 0),
          plot_grid(dh2, d2, ncol = 1, rel_heights = c(.4, .6), labels = c("C", "D")),
          ncol = 2)
