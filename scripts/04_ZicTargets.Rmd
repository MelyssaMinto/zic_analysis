...
go_fig = plot_grid(d1, d2, labels = c("D", "E"), nrow  =1)


fig4B = plot_grid( e2,
                   plot_grid(tracks_fig, go_fig, ncol=1, rel_heights = c(.7, .3)),
                   labels = c("A"),
                   nrow = 1,
                   rel_widths = c(.4, .6))
...
png("../figures/figure4B.png", height = 15, width = 15, res = 300, units = "in")
fig4B
dev.off()
