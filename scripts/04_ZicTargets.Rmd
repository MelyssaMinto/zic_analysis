...
loci = bind_rows(list(Late= zic_cutnrun_anno_up@annoStat, Early = zic_cutnrun_anno_down@annoStat, Static = zic_cutnrun_anno_static@annoStat),.id = "id") %>% 
  ...
  theme_classic() +
  scale_x_discrete(limits = c("Early", "Static", "Late")) +
