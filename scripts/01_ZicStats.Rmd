...
zic_motif_hist_logo = plot_grid(zic_motif_hist,
          plot_grid(zic1_logo, zic2_logo, ncol = 1, labels = c("G", "H")),
          nrow = 1,
          rel_widths = c(.6, .4),
          labels = c("F"),
          hjust = -2)
...
png("../figures/figure1.png", height = 8, width = 16, units = "in", res = 300)
fig1
dev.off()
...
plot_grid(
  plot_grid(plot_grid(zic_ma, sa1, ncol = 1, labels = c("A", "B")), DistReads, lossGain, nrow = 1, rel_widths = c(.4, .4, .2), labels = c("", "C", "D")),
  plot_grid(lg_examples, zic_motif_hist_logo, nrow = 1, labels = c("E"), vjust = 1),
  plot_grid(zic_motif,zic_overlap, zic_loci2 , nrow = 1, rel_widths = c(.3, .4, .3), labels = c("I", "J", "K")),
          ncol =1
)
