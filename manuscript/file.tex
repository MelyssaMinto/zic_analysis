...
Motifs that were enriched early and expressed early include factors involved in cell proliferation via FGF, Wnt, and Nodal Signalling (Figure \ref{fig:DistinctTFs}D,E). These factors include Tfap4 upstream of Wnt signalling \cite{Martinez2020TheDevelopment, Song2018TranscriptionCarcinoma}, RFX proteins upstream of FGF activation \cite{Hsu2010RegulationRFX1}, TCF proteins as a part of the $\beta$-catenine pathways,and downstream targets such as  Atoh1, Ascl1, Sox17, and Neurog2 \cite{Dennis2019BHLHReprogramming}. Smad proteins were also enriched in the early Zic sites which are downstream activators of nodal signalling. In addition to factors involved in these signalling pathways, the linker protein H1.0 (H1f0) that is associated with proliferation and differentiation is also an enriched in early Zic binding \cite{DiLiegro2018H1.0Differentiation}. Zic sites are also enriched for factors that are important in axon guidance (Nkx2.2) \cite{}, and cellular migration (Pbx3,Pknox1, Lhx1) \cite{}. Overall, Zic peaks at P7 were enriched for Homeobox and bHLH factors TF (Figure \ref{}). This is consistent with previous studies implicating Zic as a regulator of pro-neural bHlH factors in early proliferative stages neuronal differentiation \cite{Aruga2018ZicDisease}.

%Not mentoined: Srebf1 and Srepf2
...
\subsection*{Chromatin repressive complexes are early collaborators of Zic}
There is strong signature of chromatin remodeling factors whose ChIP binding profiles and motif enrichment overlap early Zic binding sites. TFs that are members or interact with of cohesin complex  (CTCF, Rad21, Stag1, Smc3, Top2b, and Smchd1), Polycomb  complex (BMI1, Phc1, Pcgf6,Phf19, Pcgf2, Arid3a, and Usf1 ), HP1 complex (Cbx5, Trim28), Nurd Complex (Trim28, Mbd3, Chd7), REST complex and BAF complex ( Top2b, Smarcad1, Bcl11a) are distinctly enriched in early Zic binding (Figure\ref{fig:DistinctTFs}D,E). In addition to members of these large complexes, factors involved in demethylation including Tet1, Kdm4b, and methylation Ehmt2, and Prdm13 are early collaborators of Zic. These data suggest that Zic interacts with chromatin remodeling factors to activate gene expression programs important to the developing cerebellum. 

\subsection*{Handoff factors enriched in early Zic sites }
Handoff factors enriched in early Zic sites factors that have been shown to interact with the core HDAC complex including (Smad3, Mecp2) and PRC1 (E2f6, Cbx7). Interestingly. HDACs are a subunit of PRC1 \cite{Aranda2015RegulationProteins}. Foxo factors are another group of handoff factors that are enriched in the early zic sites that are known to be important in migration and placement of CGNs \cite{}.

\subsection*{Modes of Late Zic binding}
Unlike the factors enriched early that have a overwhelming presence in chromatin remodeling and repression, the factors enriched late can be split into two groups: 1) Factors that are important in the switch from proliferation to differentiation 2) Factors that are transcriptionally enriched late that show signatures of activity regulated gene expression. 

Factors that are enriched in the late Zic sites but transcriptionally enriched early are labelled as recruiters of Zic binding. These Factors 
